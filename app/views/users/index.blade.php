        ...
        <form class="form-horizontal" ng-submit="submitForm()">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" rows="3" type="password" ng-model="user.password" placeholder="Password" required="">
                </div>
                <div class="form-group">
                    <label for="titlename">คำนำหน้า</label>
                    <select class="form-control" rows="3" ng-model="user.titlename" id="titlename" class="form-control" >
                        <option>นาย</option>
                        <option>นาง</option>
                ...
                <div class="form-group">
                    <label for="SurnameTh">นามสกุล</label>
